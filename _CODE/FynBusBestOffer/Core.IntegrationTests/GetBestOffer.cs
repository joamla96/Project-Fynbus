...
namespace Core.IntegrationTests
{
	...
	public class GetBestOffer
	{
		...
		Contractor _testContractor1; // = new Contractor(163460, "Navn A", "Firma A", "Apple@Email.com", new int[] { 3, 0, 0, 0, 0 });
		Contractor _testContractor2; // = new Contractor(163478, "Navn B", "Firma B", "Banana@Email.com", new int[] { 2, 0, 0, 0, 0 });
		Contractor _testContractor3; // = new Contractor(164758, "Navn C", "Firma C", "Canada@Email.com", new int[] { 1, 0, 0, 0, 0 });

		// GarantiVognNr, Start, Type, Hours: Normal, Weekend, Holidays
		Route _testRoute1; // = new Route(2502, "OUH", 2, 9.5, 10.5, 9.5, 10.5, 9.5, 10.5);
		Route _testRoute2; // = new Route(2503, "OUH", 2, 9.5, 10.5, 0, 0, 0, 0);
		Route _testRoute3; // = new Route(2504, "OUH", 2, 9.5, 10.5, 0, 0, 9.5, 10.5);
		Route _testRoute4; // = new Route(2505, "OUH", 2, 9.5, 10.5, 0, 0, 0, 0);
		Route _testRoute5; // = new Route(2506, "Ørbækvej", 2, 9.5, 10.5, 0, 0, 0, 0);

		// SeqNr, Route, Price/Hr, Contractor, RoutePrio, ContractorPrio
		Offer _testOffer1; // = new Offer(160867, _testRoute1, 284, _testContractor3, 0, 0);
		Offer _testOffer2; // = new Offer(163900, _testRoute1, 300, _testContractor2, 0, 0);

		Offer _testOffer3; // = new Offer(161170, _testRoute2, 123, _testContractor3, 0, 0);
		Offer _testOffer4; // = new Offer(163905, _testRoute2, 456, _testContractor2, 0, 0);
		Offer _testOffer5; // = new Offer(167514, _testRoute2, 789, _testContractor1, 0, 0);

		Offer _testOffer6; // = new Offer(169856, _testRoute3, 852, _testContractor1, 0, 0);
		Offer _testOffer7; // = new Offer(160456, _testRoute3, 479, _testContractor2, 1, 0);

		[TestInitialize]
		public void PrepareTests() {
			// SeqNr, Name, Company, Email, CarType 2, 3, 5, 6, 7
			_testContractor1 = new Contractor(163460, "Navn A", "Firma A", "Apple@Email.com", new int[] { 3, 0, 0, 0, 0 });
			_testContractor2 = new Contractor(163478, "Navn B", "Firma B", "Banana@Email.com", new int[] { 2, 0, 0, 0, 0 });
			_testContractor3 = new Contractor(164758, "Navn C", "Firma C", "Canada@Email.com", new int[] { 1, 0, 0, 0, 0 });
		...
		public void GetBestOfferByRoutes2() {
			...
			Console.WriteLine(bestOffer.ToString());
			Console.WriteLine(_testOffer3.ToString());
		...
		public void IfContractorOutOfCarsAwardToNext() {
			...
			Assert.AreEqual(_testRoute1.OfferWon, bestOfferR1);
			Assert.AreEqual(_testRoute2.OfferWon, bestOfferR2);
		}
	}
}
